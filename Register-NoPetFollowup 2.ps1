# Register-NoPetFollowup.ps1
# Run as Administrator to register the daily no-pet followup task
# Runs every day at 10:00 AM

$taskName   = "RuffLife-NoPetFollowup"
...
Write-Host "Registered: $taskName — runs daily at 10:00 AM"
